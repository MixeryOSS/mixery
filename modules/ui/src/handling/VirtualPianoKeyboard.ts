...
export namespace VirtualPianoKeyboard {
    ...
    export function useMixeryLayout(workspace: MixeryUI.WorkspaceView) {
        workspace.virtualPianoKeybinds.keybinds = [
            ...
            key(workspace, 72, "Shift + KeyA"), key(workspace, 73, "KeyW"),
            key(workspace, 74, "Shift + KeyS"), key(workspace, 75, "KeyE"),
            key(workspace, 76, "Shift + KeyD"),
            key(workspace, 77, "Shift + KeyF"), key(workspace, 78, "KeyT"),
            key(workspace, 79, "Shift + KeyG"), key(workspace, 80, "KeyY"),
            key(workspace, 81, "Shift + KeyH"), key(workspace, 82, "KeyU"),
            key(workspace, 83, "Shift + KeyJ"),
            key(workspace, 84, "Shift + KeyK"), key(workspace, 85, "KeyO"),
            key(workspace, 86, "Shift + KeyL"), key(workspace, 87, "KeyP"),
